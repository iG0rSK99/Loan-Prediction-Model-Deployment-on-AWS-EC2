...
@app.route('/')
def home():
    return render_template('intex.html') #read index.html file
...
def predict():
    ...
    if prediction == 0:
        return render_template('intex.html',prediction_text = "Loan is Rejected").format(prediction)
    else:
        return render_template('intex.html', prediction_text = "Loan is Approved").format(prediction)
